  ...
  return (
    <div className='customsNotesArea'>
      ...
      <div>
        ...
        1. Kesin ödeyeceğiniz miktar gümrüğe gittiğinizde belli olacaktır.<br />
        2. KDV ödediğinize ve geri aldığınıza dair bütün belgeleri, tercümesiyle birlikte yanınızda bulundurunuz.
        ...
        1.Dilekçe (Gideceğiniz gümrükte var)<br />
        2.Taahhütname (Gideceğiniz gümrükte var)<br />
        2.Sizin ve varsa eşinizin pasaportları ve ön sayfa fotokopileri<br />
        3.MEMURLAR İÇİN: kurumunuz personel dairesinden alacağınız yurtdışı görevinizin başlama bitiş tarihlerini gösteren yazı.<br />
        4.Yabancı ülkeden aldığınız ruhsat belgesi, tercümesi ve fotokopisi.<br />
        5.Fatura ve Ödeme belgenizin (varsa orjinali), tercümesi ve fotokopisi.<br />
        6.Ziraat Bankasından bir hesap açın, mobil programı telefonunuza indirin. Parayı hazırda tutun, gümrük ödemeleriniz Ziraat 
        ...
        5.Araç fenni muayene. Herhangi bir TUVTURK istasyonunda oluyor.Yaklaşık 400-500 tl.<br />
        6.Ankara'da iseniz Balgat 40.Noterine gidin. Diğer noterler bu işi bilmeyebiliyor bazen. Yaklaşık 250 tl.<br />
        7.Plaka basım yerine gidin. Yaklaşık 60 tl (2021 Şubat fiyatı).<br />
        8.Son olarak elinizdeki araç ve gümrükle ilgili belgelerle birlikte Vergi Müdürlüğüne gidin. Ankara'da: Yenimahalle Yeğenbey 
        Vergi Müdürlüğü. Burada aracınızı vergi sistemine kaydediyorlar, sonra da MTVsini ödüyorsunuz.<br />
        <p>Aracınız hayırlı olsun. Sorularınız için: drysoftware1@gmail.com</p>
